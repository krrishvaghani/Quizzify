    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Join Quizzify</h1>
        ...
        >
          <div className="grid grid-cols-1 gap-4 text-center">
            <div className="bg-white/50 backdrop-blur-sm rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600">AI adapts to your learning style and pace</p>
            </div>
            <div className="bg-white/50 backdrop-blur-sm rounded-lg p-4">
              <h3 className="font-semibold text-gray-800 mb-2">📊 Detailed Analytics</h3>
              <p className="text-sm text-gray-600">Track your progress with comprehensive insights</p>
            </div>
          </div>
        </motion.div>
      </div>
