      ...
      <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
          ...
          <div className="mt-6">
            ...
            <button
              type="button"
              className="mt-4 w-full bg-white text-gray-700 py-3 rounded-lg border-2 border-gray-300 hover:border-blue-600 hover:text-blue-600 font-medium transition-all flex items-center justify-center gap-2"
            >
